    ...
    try {
        ...
        fetch(NSSPIP_API_URL, {
            ...
            headers: { 
                ...
                "X-Sync-Token": process.env.NSSPIP_SYNC_TOKEN || "",
            },
            body: JSON.stringify({
                ...
                reportedBy: incident.createdById || "CITIZEN",
        ...
        .then(res => res.json())
        .then(syncRes => {
            console.log(`[SYNC] Incident ${incident.id} forwarded to NSSPIP. NSSPIP ID: ${syncRes.id}`);
        })
        .catch(err => {
